.class public abstract Lcarbon/recycler/ItemTouchHelper$Callback;
...
.field private static final sUICallback:Landroidx/recyclerview/widget/ItemTouchUIUtil;
...
.method static constructor <clinit>()V
    ...
    .line 1293
    new-instance v0, Lcarbon/recycler/ItemTouchHelper$Callback$1;

    invoke-direct {v0}, Lcarbon/recycler/ItemTouchHelper$Callback$1;-><init>()V

    sput-object v0, Lcarbon/recycler/ItemTouchHelper$Callback;->sDragScrollInterpolator:Landroid/view/animation/Interpolator;

    .line 1299
    new-instance v0, Lcarbon/recycler/ItemTouchHelper$Callback$2;

    invoke-direct {v0}, Lcarbon/recycler/ItemTouchHelper$Callback$2;-><init>()V

    sput-object v0, Lcarbon/recycler/ItemTouchHelper$Callback;->sDragViewScrollCapInterpolator:Landroid/view/animation/Interpolator;

    .line 1313
    new-instance v0, Lcarbon/recycler/ItemTouchUIUtilImpl$Carbon;

    invoke-direct {v0}, Lcarbon/recycler/ItemTouchUIUtilImpl$Carbon;-><init>()V

    sput-object v0, Lcarbon/recycler/ItemTouchHelper$Callback;->sUICallback:Landroidx/recyclerview/widget/ItemTouchUIUtil;
...
.method public constructor <init>()V
    ...
    .line 1310
    iput v0, p0, Lcarbon/recycler/ItemTouchHelper$Callback;->mCachedMaxScrollSpeed:I
...
.method public static getDefaultUIUtil()Landroidx/recyclerview/widget/ItemTouchUIUtil;
    ...
    .line 1356
    sget-object v0, Lcarbon/recycler/ItemTouchHelper$Callback;->sUICallback:Landroidx/recyclerview/widget/ItemTouchUIUtil;
...
.method private getMaxDragScroll(Landroidx/recyclerview/widget/RecyclerView;)I
    ...
    .line 1769
    iget v0, p0, Lcarbon/recycler/ItemTouchHelper$Callback;->mCachedMaxScrollSpeed:I
    ...
    sget v0, Lcarbon/R$dimen;->item_touch_helper_max_drag_scroll_per_frame:I

    invoke-virtual {p1, v0}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result p1

    iput p1, p0, Lcarbon/recycler/ItemTouchHelper$Callback;->mCachedMaxScrollSpeed:I

    .line 1773
    :cond_0
    iget p1, p0, Lcarbon/recycler/ItemTouchHelper$Callback;->mCachedMaxScrollSpeed:I
...
.method public static makeMovementFlags(II)I
    ...
    .line 1401
    invoke-static {v0, v1}, Lcarbon/recycler/ItemTouchHelper$Callback;->makeFlag(II)I
    ...
    .line 1402
    invoke-static {v1, p1}, Lcarbon/recycler/ItemTouchHelper$Callback;->makeFlag(II)I
    ...
    .line 1403
    invoke-static {v0, p0}, Lcarbon/recycler/ItemTouchHelper$Callback;->makeFlag(II)I
...
.method public clearView(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
    ...
    .line 1903
    sget-object p1, Lcarbon/recycler/ItemTouchHelper$Callback;->sUICallback:Landroidx/recyclerview/widget/ItemTouchUIUtil;
...
.method final getAbsoluteMovementFlags(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)I
    ...
    .line 1478
    invoke-virtual {p0, p1, p2}, Lcarbon/recycler/ItemTouchHelper$Callback;->getMovementFlags(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)I
    ...
    invoke-virtual {p0, p2, p1}, Lcarbon/recycler/ItemTouchHelper$Callback;->convertToAbsoluteDirection(II)I
...
.method hasDragFlag(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)Z
    ...
    .line 1483
    invoke-virtual {p0, p1, p2}, Lcarbon/recycler/ItemTouchHelper$Callback;->getAbsoluteMovementFlags(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)I
...
.method public interpolateOutOfBoundsScroll(Landroidx/recyclerview/widget/RecyclerView;IIIJ)I
    ...
    .line 2025
    invoke-direct {p0, p1}, Lcarbon/recycler/ItemTouchHelper$Callback;->getMaxDragScroll(Landroidx/recyclerview/widget/RecyclerView;)I
    ...
    .line 2030
    sget-object p4, Lcarbon/recycler/ItemTouchHelper$Callback;->sDragViewScrollCapInterpolator:Landroid/view/animation/Interpolator;
    ...
    .line 2038
    sget-object p2, Lcarbon/recycler/ItemTouchHelper$Callback;->sDragScrollInterpolator:Landroid/view/animation/Interpolator;
...
.method onDraw(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;Ljava/util/List;IFF)V
    ...
    check-cast v0, Lcarbon/recycler/ItemTouchHelper$RecoverAnimation;

    .line 1847
    invoke-virtual {v0}, Lcarbon/recycler/ItemTouchHelper$RecoverAnimation;->update()V
    ...
    .line 1849
    iget-object v3, v0, Lcarbon/recycler/ItemTouchHelper$RecoverAnimation;->mViewHolder:Landroidx/recyclerview/widget/RecyclerView$ViewHolder;

    iget v4, v0, Lcarbon/recycler/ItemTouchHelper$RecoverAnimation;->mX:F

    iget v5, v0, Lcarbon/recycler/ItemTouchHelper$RecoverAnimation;->mY:F

    iget v6, v0, Lcarbon/recycler/ItemTouchHelper$RecoverAnimation;->mActionState:I
    ...
    invoke-virtual/range {v0 .. v7}, Lcarbon/recycler/ItemTouchHelper$Callback;->onChildDraw(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;FFIZ)V
...
.method onDrawOver(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;Ljava/util/List;IFF)V
    ...
    invoke-virtual/range {v0 .. v7}, Lcarbon/recycler/ItemTouchHelper$Callback;->onChildDrawOver(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;FFIZ)V
    ...
    .line 1879
    iget-boolean v2, v1, Lcarbon/recycler/ItemTouchHelper$RecoverAnimation;->mEnded:Z

    if-eqz v2, :cond_2

    iget-boolean v2, v1, Lcarbon/recycler/ItemTouchHelper$RecoverAnimation;->mIsPendingCleanup:Z
    ...
    .line 1881
    :cond_2
    iget-boolean v1, v1, Lcarbon/recycler/ItemTouchHelper$RecoverAnimation;->mEnded:Z
...
.method public onMoved(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;ILandroidx/recyclerview/widget/RecyclerView$ViewHolder;III)V
    ...
    .line 1813
    instance-of v0, p3, Lcarbon/recycler/ItemTouchHelper$ViewDropHandler;

    if-eqz v0, :cond_0

    .line 1814
    check-cast p3, Lcarbon/recycler/ItemTouchHelper$ViewDropHandler;

    iget-object p1, p2, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->itemView:Landroid/view/View;

    iget-object p2, p4, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->itemView:Landroid/view/View;

    invoke-interface {p3, p1, p2, p6, p7}, Lcarbon/recycler/ItemTouchHelper$ViewDropHandler;->prepareForDrop(Landroid/view/View;Landroid/view/View;II)V
...
.method public onSelectedChanged(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;I)V
    ...
    .line 1764
    sget-object p2, Lcarbon/recycler/ItemTouchHelper$Callback;->sUICallback:Landroidx/recyclerview/widget/ItemTouchUIUtil;
